...
class KartuScanDetail extends StatelessWidget {
  final Data data;
  const KartuScanDetail (this.data, {super.key});
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text('${data.tLahir}, ${data.tgLahir}', style: fontRegular.copyWith(
                                color: greenPrimary,
                                fontSize: 14.0,
                                fontWeight: FontWeight.w500)),
                          ),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text('${data.jkl}', style: fontRegular.copyWith(
                                color: greenPrimary,
                                fontSize: 14.0,
                                fontWeight: FontWeight.w500)),
                          ),
